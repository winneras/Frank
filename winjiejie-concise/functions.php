...
function frank_footer() {
    ...
    if ($frank_general && isset($frank_general['footer']))
        echo stripslashes($frank_general['footer']);
}

function frank_header() {
    $frank_general = get_option('_frank_options');
    if ($frank_general && isset($frank_general['header']))
        echo stripslashes($frank_general['header']);
}

function frank_tweet_post_button() {
    $frank_general = get_option('_frank_options');
    if ($frank_general && $frank_general['tweet_post_button'])
        return true;
}
...
function frank_tweet_post_attribution() {
    $frank_general = get_option('_frank_options');
    if ($frank_general)
        return $frank_general['tweet_post_attribution'];
}
